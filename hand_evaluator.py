...
# print([Card.from_id(a[0]).__str__(), Card.from_id(a[1]).__str__()]+[Card.from_id(a[2]).__str__(), Card.from_id(a[3]).__str__(), Card.from_id(a[4]).__str__(), Card.from_id(a[5]).__str__(), Card.from_id(a[6]).__str__()])
# h=HandEvaluator.eval_hand([Card.from_str('DA'), Card.from_str('HA')], [Card.from_str('ST'), Card.from_str('D7'), Card.from_str('D9'), Card.from_str('C4'), Card.from_str('C5')])
